...
export const pageContracts: PageContract[] = [
  ...
  { path: "/experiences/coffee-bar", page: "Coffee Bar", purpose: "Position Luxe Coffee Bar as a complete café and beverage experience rather than a basic mobile coffee cart.", primaryCta: "Inquire About Coffee Service", secondaryCta: "Explore Sweet Cart", indexable: true, audienceGroups: ["weddings", "corporate", "brand-activations", "private-events"], schemaPlan: ["Service", "BreadcrumbList", "WebPage", "FAQPage when visible FAQ content is approved"] },
  ...
  { path: "/inquire", page: "Inquire", purpose: "Prepare qualified visitors for the inquiry process and transfer them into the selected third-party platform.", primaryCta: "Begin Your Inquiry", secondaryCta: "Review What to Prepare", indexable: true, audienceGroups: ["weddings", "corporate", "brand-activations", "private-events"], schemaPlan: ["ContactPage", "BreadcrumbList", "WebPage"] },
];
