    ...
    <SiteShell>
      <main className={`foundation-detail foundation-detail-${experience.accent}`}>
        ...
        <section className="foundation-detail-section">
          ...
          <div className="foundation-detail-panel"><p>Every Luxe division can be booked independently and remains easy to combine with complementary experiences when the occasion calls for a coordinated approach.</p><Link href="/inquire">Ask about this experience <span aria-hidden="true">↗</span></Link></div>
        </section>
